                        ...
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}" style="height: 430px;">
                            ...
                            <div
                                ...
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-6 text-white mb-3 animate__animated animate__fadeInDown">
                                        {{ $sliderItem->title }}</h3>
                    ...
                    @if ($key < 2)
                        ...
                        <div class="product-offer" style="height: 200px; margin-bottom: 30px">
                            ...
                            <div class="offer-text">
                                ...
                                <h3 class="text-white mb-3 text-center">{{ $sliderItem->title }}</h3>
                            </div>
                        </div>
                    @endif
                @endforeach
     ...
     <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            @empty
                <div class="col-md-12">
                    <div class="p-2">
                        <h4 class="text-center">@lang('public.no')</h4>
                    </div>
                </div>
            @endforelse
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="{{ url('/collections/' . $productItem->category->slug . '/' . $productItem->slug) }}"> {{ $productItem->name }} </a>
                                    <div class="d-flex align-items-center justify-content-around mt-2">
                                        ...
                                        @else
                                             <h6 class="text-muted ml-2">{{ number_format($productItem->original_price) }} UZS</h6>
                                        @endif
                                    </div>
                                </a>
                            </div>
                ...
                @if ($key < 2)
                    <div class="col-md-6 mt-1">
                        <div class="product-offer mb-30" style="height: 300px;">
                            <img class="img-fluid" src="{{ asset("$sliderItem->image") }}" alt="">
                            <div class="offer-text col-md-12">
                                <center class="">
                                    <h6 class="text-white text-center text-uppercase w-75">{{ $sliderItem->description }}</h6>
                                    <h3 class="text-white text-center mb-3">{{ $sliderItem->title }}</h3>
                                </center>
                            </div>
                        </div>
                    </div>
