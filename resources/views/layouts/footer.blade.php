    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5" id="footer">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-phone-alt text-white mr-3"></i>{{ $appSetting->phone1 ?? 'phone' }}</p>
                <p class="mb-0 w-100 d-flex"><i class="fa fa-solid fa-truck-fast text-white mr-3"></i>@lang('public.dastafka_info')</p>
               <!--  <i class=""></i> -->
            </div>
